...
class DCEIFlow(nn.Module):
    def __init__(self, args, split='test'):
        ...
        self.isbi = False # args.isbi
        self.event_bins = args.voxel_bins # args.event_bins if args.no_event_polarity is True else 2 * args.event_bins
    ...
    def forward(self, image1, image2, voxel, iters=6, flow_init=None, upsample=True):
        ...
        event_voxel = voxel # batch['event_voxel']
